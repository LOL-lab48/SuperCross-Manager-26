...
const incidentPool = [
  "Jumped under red flag",
  "Ignored yellow flag",
  "Passed under waving yellow",
  "Aggressive block pass",
  "Unsafe rejoin",
  "False start",
  "Illegal bike modification",
  "Outside assistance",
  "Improper pit entry",
  "Track cutting",
  "Multi-rider pileup",
  "Bike fire during race",
  "Medical flag ignored",
  "Helmet removed on track",
  "Black flag ignored",
  "Weaving on straight",
  ...
  "Track lights failure",
  "Wrong gate assigned",
  "Throttle stuck open",
  "Lost bike part on track",
  "Jumped tuff blocks",
  "Rode restricted area",
  "Unsafe marshal interaction",
  "Excessive noise",
  "Fuel rule violation",
  "Chain failure oil spill",
  "Verbal abuse of official",
  "Physical altercation",
  "Delayed race restart",
  "Incorrect lineup order",
  "Jumped on red-cross flag",
  "Ignoring slowdown zone",
  "Illegal tire compound",
  "Jumping under caution",
  "Late contact pass",
  "Blocking lapped rider",
  "Medical helicopter delay",
  "Start device violation",
  "Track rut manipulation",
  "Bike stalled on start",
  "Mechanical black smoke",
  "Team radio interference",
  "Marshal instruction ignored",
  "Jump timing sensor fault",
  "Restart jump violation",
  "Wrong penalty board shown",
...
function startRace() {
  ...
  const incidentCount = Math.floor(Math.random()*6); // 0–5
...
function showIncident() {
  ...
  btn("Time Penalty", ()=>choosePenalty("Time (sec)",[5,10,20,30]));
  btn("Place Penalty", ()=>choosePenalty("Place",[1,2,3,5]));
...
function resolve(penalty) {
  ...
  if (Math.random()>stewardSkill) popularity-=2;
